...
import { ListService } from 'src/app/services/others/list.service';
...
export class EditProveedorComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.paisList=this.listService.getPaisList()
  }
  ...
  updateInfo(){
    ...
    this.supplier.businessArea=this.data.businessArea
